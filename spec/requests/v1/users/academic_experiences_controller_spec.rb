...
describe V1::Users::AcademicExperiencesController do
  ...
  let(:academic_degree){ AcademicDegree.create!(name: "Diploma", locale: "es") }
  ...
  let(:valid_params) do
    { degree: "Engineer", institution: "UNET", start_date: "15-02-2010", end_date: "17-06-2015",
      ...
      academic_degree_id: academic_degree.id, academic_area_id: academic_area.id }
  end
  ...
  describe "POST users/:id/experiences" do
    context "With valid params" do
      it "Should create a new experience for current user" do
        ...
        expect(last_experience.academic_degree).to eq(academic_degree)
